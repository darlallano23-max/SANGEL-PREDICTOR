...
document.addEventListener("DOMContentLoaded", function() {
    // 1. Inicializar el mapa de inmediato con coordenadas estándar
    ...
    // Forzar a Leaflet a recalcular el espacio visual por si cargó oculto
    setTimeout(() => {
        map.invalidateSize();
    }, 400);

    // 2. Cargar el JSON de riesgos
    fetch('data/datos_macro_riesgo.json')
        .then(res => res.json())
        .then(data => {
            datosPaisesLocales = data;
            console.log("Data logística cargada:", datosPaisesLocales);
            comenzarPintadoMapamundi();
        })
        .catch(err => console.error("Error leyendo datos_macro_riesgo.json:", err));
});
        ...
        .then(geojsonData => {
            ...
            geojsonLayer = L.geoJson(geojsonData, {
                style: function(feature) {
                    // Mapeo flexible por ID de país (admite iso_a2, id, properties.id)
                        ...
                        const contenidoPopup = `
                            <div style="font-family: Arial, sans-serif; padding: 5px; min-width: 180px;">
                                ...
                                <table style="width: 100%; font-size: 12px;">
                                    ...
                                    <tr style="border-top: 1px solid #eee;"><td style="padding-top:4px;"><b>Score:</b></td>
            ...
            console.log("¡Mapa coloreado correctamente!");
        })
